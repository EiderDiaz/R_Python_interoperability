...
rlib = ffi.dlopen(name="C:/Program Files/R/R-3.6.3/bin/x64/R.dll")
...
df = pd.read_csv('C:/Users/Jose/Dropbox (Personal)/Documents/FRESACAD/TADPOLE/TADPOLE/TADPOLE_Submission_BORREGOTECMTY.csv')
# print('df', df)

#data_path_train_test = Path("C:/Users/Jose/Dropbox (Personal)/Documents/FRESACAD/TADPOLE/TADPOLE/TADPOLE_D1_D2.csv")
...
trueDf.to_csv('C:/Users/Jose/Dropbox (Personal)/Documents/FRESACAD/TADPOLE/TADPOLE/SD4_dummy.csv',index=False)
